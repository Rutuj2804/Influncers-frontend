...
import { fetch_requested_user } from '../../store/display-user/actions'
import { fetch_display_users_listings } from '../../store/actions'
import Listing from '../../components/home/Listing'

const ViewProfile = ({ user_from_state, fetch_requested_user, match, fetch_display_users_listings, my_listings_from_state }) => {
    ...
    useEffect(()=>{
        fetch_requested_user(username, history)
        fetch_display_users_listings(username)
...
const mapStateToProps = state => ({
    user_from_state: state.DisplayUser,
    my_listings_from_state: state.Dashboard.my_listings,
})

export default connect(mapStateToProps, { fetch_requested_user, fetch_display_users_listings })(ViewProfile)